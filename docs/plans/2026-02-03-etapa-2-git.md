# Stage 2: Git - Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Implement the Git module using git2 to obtain repository information (branch, dirty status, ahead/behind, staged/unstaged) with three configurable detail levels.

**Architecture:** Wrapper over git2 that exposes a simple API to get GitInfo from a path. Three detail levels (minimal, standard, detailed) that determine how much information is collected. Graceful error handling (path is not repo, corrupt repo, etc.).

**Tech Stack:** git2 (libgit2 bindings), GitInfoLevel from config module.

---

## Task 1: Define structs for Git information

**Files:**
- Modify: `src/git/mod.rs`

**Step 1: Create Git information structs**
...
## Task 2: Implement current branch detection

**Files:**
- Modify: `src/git/mod.rs`

**Step 1: Add function to get branch**
...
## Task 3: Implement dirty status detection

**Files:**
- Modify: `src/git/mod.rs`

**Step 1: Add function for dirty status**
...
## Task 4: Implement ahead/behind counting

**Files:**
- Modify: `src/git/mod.rs`

**Step 1: Add function for ahead/behind**
...
## Task 5: Implement staged/unstaged counting

**Files:**
- Modify: `src/git/mod.rs`

**Step 1: Add function for staged/unstaged**
...
## Task 6: Implement modified files list

**Files:**
- Modify: `src/git/mod.rs`

**Step 1: Add function to list modified files**
...
## Task 7: Implement main get_git_info function

**Files:**
- Modify: `src/git/mod.rs`

**Step 1: Add get_git_info function with levels**
...
## Task 8: Create unit tests for Git module
...
Add at the end of `src/git/mod.rs`:
